...
var Stepper = React.forwardRef(function Stepper(props, ref) {
  ...
  var steps = childrenArray.map(function (step, index) {
    ...
    return [!alternativeLabel && connector && index !== 0 && React.cloneElement(connector, (0, _extends2.default)({
      key: index
    }, state)), React.cloneElement(step, (0, _extends2.default)({}, controlProps, {}, state, {}, step.props))];
  });
