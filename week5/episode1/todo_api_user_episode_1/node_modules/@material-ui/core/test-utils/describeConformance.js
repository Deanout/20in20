...
function testClassName(element, getOptions) {
  it('applies the className to the root component', function () {
    ...
    _chai.assert.strictEqual((0, _findOutermostIntrinsic.default)(wrapper).hasClass(className), true, 'does have a custom `className`');
  });
}
/**
...
function testComponentProp(element, getOptions) {
  describe('prop: component', function () {
    it('can render another root component with the `component` prop', function () {
      ...
      _chai.assert.strictEqual(findRootComponent(wrapper, {
        classes: classes,
        component: component
      }).exists(), true);
    });
...
function testPropsSpread(element, getOptions) {
  it("spreads props to the root component", function () {
    ...
    var wrapper = mount(React.cloneElement(element, (0, _defineProperty2.default)({}, testProp, value)));
    var root = findRootComponent(wrapper, {
      classes: classes,
      component: inheritComponent
    });

    _chai.assert.strictEqual(root.props()[testProp], value);
  });
}
/**
...
function testRootClass(element, getOptions) {
  it('applies the root class to the root component if it has this class', function () {
    ...
    _chai.assert.strictEqual((0, _findOutermostIntrinsic.default)(wrapper).hasClass(classes.root), true);

    _chai.assert.strictEqual((0, _findOutermostIntrinsic.default)(wrapper).hasClass(className), true);
  });
}
/**
