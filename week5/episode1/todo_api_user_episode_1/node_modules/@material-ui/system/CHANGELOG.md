...
- [Popper] Avoid popper.js npm warning (#20433) @oliviertassinari
...
- [theme] Fix types to pass array for spacing (#20486) @denys-pavlenko
- [theme] Fix types for theme.spacing (#20435) @m4theushw
...
- [Autocomplete] Correct example of virtualization (#20496) @galkadaw
